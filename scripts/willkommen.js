...
const MODUL = {
  name: "Ninjo's DnD Reference Sheet",
  icon: "fa-solid fa-rectangle-list",
  slug: "ndrs",
  untertitel: "NDRS.Willkommen.Untertitel",
  einleitung: "NDRS.Willkommen.Einleitung",
  punkte: [
    "NDRS.Willkommen.Punkt1",
    "NDRS.Willkommen.Punkt2",
    "NDRS.Willkommen.Punkt3"
  ],
  start: "NDRS.Willkommen.Start"
};
...
export async function willkommenZeigen() {
    ...
    <div class="ninjo-willkommen">
      ...
      <a class="ninjo-willkommen-forge" href="${forgeAdresse()}" target="_blank" rel="noopener">
        ...
        <span class="ninjo-willkommen-forge-text">
          ...
          <span class="ninjo-willkommen-forge-zeile">${text("NDRS.Willkommen.ForgeZeile")}</span>
        </span>
      ...
      <a class="ninjo-willkommen-patreon" href="${PATREON}" target="_blank" rel="noopener">
        ...
        <span>${text("NDRS.Willkommen.PatreonZeile")}</span>
      </a>
    </div>`;
  ...
  const antwort = await foundry.applications.api.DialogV2.wait({
    ...
    buttons: [
      {
        action: "nie",
        label: "NDRS.Willkommen.Nie",
        icon: "fa-solid fa-check",
        default: true
      },
      {
        action: "spaeter",
        label: "NDRS.Willkommen.Spaeter",
